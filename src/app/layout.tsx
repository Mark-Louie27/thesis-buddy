...
export const metadata: Metadata = {
  title: "Thesis Buddy — Capstone made manageable",
  description:
    "Reference management, RRL synthesis, milestone tracking, and APA 7th formatting built for Filipino thesis and capstone students.",
  icons: {
    icon: "/icon.svg",
  },
};
